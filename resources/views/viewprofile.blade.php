   ...
   <div class="page-container">
        <header class="header">
            ...
            <div class="page-header">
                <form action="{{ url('/viewprofile') }}" method="GET" class="view-id-search" role="search" aria-label="Search profiles by ID">
                    @csrf
                    <input type="text" name="id" placeholder="Search by ID" value="{{ request('id') }}" aria-label="Profile ID" />
