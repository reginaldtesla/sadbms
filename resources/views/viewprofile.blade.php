...
@section('content')
    <div class="welcome-box viewprofile-header">
        <h2>All User Profiles</h2>
        <p>Browse and manage personnel profiles. Use search to filter by name, year, or company location.</p>

        <form action="{{ url('/viewprofile') }}" method="GET" class="profile-filter-form search-form" role="search" aria-label="Search profiles by name, year, and company location">
